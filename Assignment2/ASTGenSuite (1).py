...
"""
        expect = '''Program([FuncDecl(Id(main), [], Block([VarDecl(Id(i), None, var, NumLit(0.0)), If(NumLit(1.0), For(Id(i), BinaryOp(=, Id(i), NumLit(10.0)), NumLit(1.0), If(NumLit(2.0), Return()), [], None)), [(NumLit(3.0), Return())], Return()]))])'''
        try:
